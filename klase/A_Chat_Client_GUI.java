...
public class A_Chat_Client_GUI {
    ...
    public static void ConfigureMainWindow()
    {
        ...
        L_ONLINE.setText("Currently Onlinei");
        ...
        String selectedItem = (String) JL_ONLINE.getSelectedValue();
    ...
    JL_ONLINE.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent evt) {
                if (evt.getValueIsAdjusting())
                    return;
                String str = (String) JL_ONLINE.getSelectedValue();

        TF_Message.setText(str + ":");
            }
        });
